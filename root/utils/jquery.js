function n(t, r, o, i) {
    ...
    else if (o || "object" !== d.type(r)) i(t, r);
    else
        for (u in r) n(t + "[" + u + "]", r[u], o, i);
}
...
var r = "function" == typeof Symbol && "symbol" == typeof Symbol.iterator ? function(n) {
    ...
    d = {
        ...
        each: function(n, r, o) {
            ...
            if (o) {
                if (u)
                    for (; e < i && !1 !== r.apply(n[e], o); e++);
                else
                    for (e in n)
                        if (!1 === r.apply(n[e], o)) break;
            } else if (u)
                for (; e < i && !1 !== r.call(n[e], e, n[e]); e++);
            else
                for (e in n)
                    if (!1 === r.call(n[e], e, n[e])) break;
            return n;
        },
        ...
        inArray: function(n, t, r) {
            ...
            if (t) {
                ...
                for (o = t.length, r = r ? r < 0 ? Math.max(0, o + r) : r : 0; r < o; r++)
...
d.extend = function() {
        ...
        if (void 0 === r && (r = !1), d.isArray(t) || t.jquery && !d.isPlainObject(t)) d.each(t, function() {
            ...
            for (o in t) n(o, t[o], r, i);
        return e.join("&").replace(y, "+");
    },
    d.path = function(t, r) {
        var o, e = [],
            i = function(n, t) {
                t = d.isFunction(t) ? t() : null == t ? "" : t, e[e.length] = encodeURIComponent(t);
            };
        if (void 0 === r && (r = !1), d.isArray(t) || t.jquery && !d.isPlainObject(t)) d.each(t, function() {
            i(this.name, this.value);
        });
